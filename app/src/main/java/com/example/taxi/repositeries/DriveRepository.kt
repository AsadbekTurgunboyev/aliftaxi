package com.example.taxi.repositeries

import androidx.lifecycle.map
import androidx.room.Transaction
import com.example.taxi.db.AppDatabase
import com.example.taxi.db.dao.DriveDao
...
class DriveRepository(private val appDatabase: AppDatabase) {
    ...
    fun getDriveLiveDataPath(id: Long) = appDatabase.driveDao().getDriveLiveData(id).map {
        it?.locationPath
    }
