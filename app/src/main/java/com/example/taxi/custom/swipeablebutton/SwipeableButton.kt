package com.example.taxi.custom.swipeablebutton
...
import com.example.taxi.databinding.ButtonSwipeBinding

class SwipeableButton @JvmOverloads constructor(
    context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : RelativeLayout(context, attrs, defStyleAttr) {
    private val binding: ButtonSwipeBinding
    ...
    init {
        binding = ButtonSwipeBinding.inflate(LayoutInflater.from(context), this, true)
...
//        buttonSwipeableTv = findViewById(R.id.buttonSwipeableTv)
    ...
    private fun setTextStartTextPadding() {
        findViewById<TextView>(R.id.buttonSwipeableTv).setPadding(0, 0, binding.slidingButtonIv.width, 0)
    }
    ...
    private fun setTextEndTextPadding() {
        binding.buttonSwipeableTv.setPadding(0, 0, 0, 0)
    }
    ...
    private fun animateToggleToStart() {
        ...
        colorAnimation.addUpdateListener { animator ->
            findViewById<TextView>(R.id.buttonSwipeableTv).setTextColor(
        ...
        paddingAnimation.addUpdateListener {
            binding.buttonSwipeableTv.setPadding(
        ...
        alphaAnimation.addUpdateListener {
            ...
            binding.buttonSwipeableTv.alpha =
                alphaAnimation.animatedValue as Float
        }
    ...
    private fun animateToggleToEnd() {
        ...
        alphaAnimation.addUpdateListener {
            ...
            findViewById<TextView>(R.id.buttonSwipeableTv).alpha =
                alphaAnimation.animatedValue as Float
        }
        ...
        paddingAnimation.duration = animationDuration
        paddingAnimation.addUpdateListener {
            findViewById<TextView>(R.id.buttonSwipeableTv).setPadding(
                0,
                0,
                it.animatedValue as Int,
                0
