...
public final class RxDownTimer {
    ...
    private RxDownTimer(Builder builder) {
        take = builder.take;
    ...
    public static final class Builder {
        ...
        public RxDownTimer build() {
            return new RxDownTimer(this);
        }
    }
}